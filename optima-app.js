...
const T = {
  sq: {
    ...
    aiPlaceholder: "Shkruaj si klient… p.sh. 'Sa kushton parfumi?'",
    ...
    staffNamePh: "Emri i personit", staffRolePh: "Roli (p.sh. specialist)", addStaff: "+ Staf",
    ...
    shareH: "📣 Linku yt", shareSub: "Një link i vetëm. Këtu vijnë klientët, këtu je edhe ti.",
    shareMain: "KY U JEP KLIENTËVE",
    sharePubD: "Për ata që s'kanë Telegram — rezervojnë vetë, pa bisedë. Vëre në bio të Instagram-it.",
    shareAlsoH: "Ke edhe një faqe rezervimesh (opsionale)",
    shareTgH: "Linku yt",
    shareTgD: "Klienti hap linkun dhe pyet — me tekst, me zë, ose me foto. AI-ja përgjigjet 24/7 dhe merr rezervimet.",
    shareFoot: "💡 Ti vetë shkruan te i njëjti link — të njeh si pronar. Shkruaj /admin për komandat.",
    ...
    tgEasyH: "⚡ Ose provoje shpejt me bot-in tonë (30 sekonda)",
    tgOwnH: "🤖 Bot me emrin TËND (rekomandohet)",
    tgOwnD: "Klientët do të shohin emrin e biznesit tënd, jo tonin. Dhe bot-i është vetëm i yti — asnjë biznes tjetër s'e prek. 3 minuta, një herë.",
    tgStep1: "Hap Telegram → kërko BotFather → hape",
    tgStep2: "Shkruaj /newbot → dërgo",
    tgStep3: "Shkruaj emrin e biznesit tënd (p.sh. Auto Blerimi)",
    tgStep4: "Shkruaj një username që mbaron me bot (p.sh. AutoBlerimiBot)",
    tgStep5: "Kopjo kodin e gjatë që të jep dhe ngjite poshtë",
    tgOwnLast: "Pas \"Aktivizo\", ndaje me klientët linkun t.me/emri-i-botit-tënd.",
    tgEasyD: "Për ta parë si punon menjëherë, pa krijuar asgjë. Klientët do të shohin emrin tonë, jo tëndin — ndaj për punë të vërtetë kalo te bot-i yt lart.",
    ...
    aboutPh: "P.sh. Parfumeri në Tiranë — parfume origjinale 50ml & 100ml, dorëzim 24h. Hapur 9:00–19:00.", saveAllBtn: "💾 Ruaj gjithçka",
    ...
    cfgVolatileLbl: "📈 Çmimet ndryshojnë shpesh", cfgVolatileHint: "Për tregti (telefona, parfume…): AI-ja jep çmim vetëm nëse është freskuar 7 ditët e fundit — përndryshe konfirmon artikullin, merr kontaktin e klientit dhe të pyet ty. Freskimi: ri-import i listës, ose në Telegram — një artikull: iPhone 15 = 430 · gjithë familja: iphone 17 = -10% · gjithë katalogu: * = +5%. Çmimi 0 = \"me kërkesë\" (punë me porosi): AI s'thotë kurrë numër, merr kërkesën + kontaktin dhe ti çon ofertën.",
  ...
  en: {
    ...
    aiPlaceholder: "Type like a customer… e.g. 'How much is the perfume?'",
    ...
    staffNamePh: "Person's name", staffRolePh: "Role (e.g. specialist)", addStaff: "+ Staff",
    ...
    shareH: "📣 Your link", shareSub: "One single link. Customers come here — and so do you.",
    shareMain: "GIVE THIS TO CUSTOMERS",
    sharePubD: "For people without Telegram — they book themselves, no chat. Put it in your Instagram bio.",
    shareAlsoH: "You also have a booking page (optional)",
    shareTgH: "Your link",
    shareTgD: "The customer opens the link and asks — by text, voice or photo. The AI answers 24/7 and takes bookings.",
    shareFoot: "💡 You write to the same link — it knows you're the owner. Type /admin for your commands.",
    tabTryAi: "🧪 Try the AI",
    ...
    tgEasyH: "⚡ Or try it fast with our bot (30 seconds)",
    tgOwnH: "🤖 A bot with YOUR name (recommended)",
    tgOwnD: "Customers will see your business name, not ours. And the bot is yours alone — no other business touches it. 3 minutes, once.",
    tgStep1: "Open Telegram → search BotFather → open it",
    tgStep2: "Send /newbot",
    tgStep3: "Type your business name (e.g. Auto Blerimi)",
    tgStep4: "Type a username ending in bot (e.g. AutoBlerimiBot)",
    tgStep5: "Copy the long code it gives you and paste it below",
    tgOwnLast: "After \"Activate\", share the link t.me/your-bot-name with customers.",
    tgEasyD: "To see how it works right away, without creating anything. Customers will see our name, not yours — so for real work use your own bot above.",
    ...
    aboutPh: "E.g. Perfume shop in Tirana — original perfumes 50ml & 100ml, 24h delivery. Open 9:00–19:00.", saveAllBtn: "💾 Save all",
    ...
    cfgVolatileLbl: "📈 My prices change often", cfgVolatileHint: "For retail (phones, perfumes…): the AI quotes a price only if it was refreshed in the last 7 days — otherwise it confirms the item, captures the customer's contact and asks you. Refresh: re-import your list, or via Telegram — one item: iPhone 15 = 430 · a whole family: iphone 17 = -10% · whole catalog: * = +5%. Price 0 = \"on request\" (made-to-order): the AI never states a number, collects the request + contact and you send the offer.",
...
const CUR_SYM = { EUR:"€", USD:"$", GBP:"£", ALL:"L", CHF:"CHF", CAD:"$", AUD:"$", NZD:"$", AED:"AED", TRY:"₺", RSD:"din", MKD:"den", RON:"lei", BGN:"лв", MDL:"L", UAH:"₴", RUB:"₽", PLN:"zł", CZK:"Kč", HUF:"Ft", SEK:"kr", NOK:"kr", DKK:"kr", ISK:"kr", INR:"₹", PKR:"₨", BDT:"৳", JPY:"¥", CNY:"¥", KRW:"₩", HKD:"$", TWD:"$", SGD:"$", MYR:"RM", THB:"฿", IDR:"Rp", PHP:"₱", VND:"₫", KZT:"₸", AZN:"₼", GEL:"₾", AMD:"֏", ZAR:"R", NGN:"₦", GHS:"₵", BRL:"R$", MXN:"$", ARS:"$", CLP:"$", COP:"$", UYU:"$" };
